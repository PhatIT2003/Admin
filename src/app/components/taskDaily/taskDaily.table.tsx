...
import CreateTaskDaily from './create.taskDaily';
import UpdateTaskDaily from './update.taskDaily';
import { ITask } from '../../types/backend';
import { handleDeleteTaskDailyAction } from '@/actions/taskDaily';
...
const TasksDailyTable = (props: Iprops) => {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            const res = await handleDeleteTaskDailyAction(id, token);
...
export default TasksDailyTable;