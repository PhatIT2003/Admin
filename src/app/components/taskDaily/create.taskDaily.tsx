import {handleCreateTaskDailyAction } from '@/actions/taskDaily';
...
const CreateTaskDaily = (props: IProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            const res = await handleCreateTaskDailyAction(taskData, token);
...
export default CreateTaskDaily;
