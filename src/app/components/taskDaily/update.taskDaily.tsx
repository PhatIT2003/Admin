import { handleUpdateTaskDailyAction } from '@/actions/taskDaily';
...
const UpdateTaskDaily = (props: IProps) => {
    ...
    const onFinish = async (values: any) => {
        ...
        if (dataUpdate) {
            ...
            if (Token) {
                await handleUpdateTaskDailyAction(data, Token);
...
export default UpdateTaskDaily;
